...
public interface IParallelNotifyCompletion
{
    ...
    // 'ParallelTask.SetResult()', until main thread set the continuation to this task.
    ...
    // }
    //
    // This flag is designed to differentiate these situation and to track, if the method contains anything that
